...
assert_contains "${INDEX_FILE}" "id=\"termsModalMount\""
assert_not_contains "${INDEX_FILE}" "id=\"termsModal\" class=\"modal-backdrop\""

assert_contains "${APP_FILE}" "function renderTermsModal()"
assert_contains "${APP_FILE}" "termsModalMount"
assert_contains "${APP_FILE}" "termsModal"
assert_contains "${APP_FILE}" "이용약관"
